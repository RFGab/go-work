...
import ru.itis.raslgab.gowork.services.qr.QrCodeService;
...
public class BookingApprovalServiceImpl implements BookingApprovalService {
    ...
    public void sendOwnerApprovalRequest(Long bookingId) {
        ...
        BookingMailDto dto = bookingDataMapper.mapToMailDto(booking);
    ...
    public BookingApprovalPageDto getApprovalPage(Long bookingId, String action) {
        ...
        String actionTitle = "approve".equals(normalizedAction) ? "Одобрить бронь" : "Отклонить бронь";
        return bookingDataMapper.mapToApprovalPageDto(booking, normalizedAction, actionTitle);
    }
